                    ...
                    <form action="/guru" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <label>username</label>
                                    <input type="text" name="username" class="form-control" placeholder="Test">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <label>Password</label>
                                    <input type="password" name="password" class="form-control" placeholder="Test">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <label>Re-Password</label>
                                    <input type="password" name="repassword" class="form-control" placeholder="Test">
                                </div>
                            </div>
